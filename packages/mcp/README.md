...
v0.7 — fifteen tools (fourteen plus the `labwired_search_tools` meta-tool), stdio transport, no auth required for local use (the simulator runs on your machine).
