# Validation Report: mpfs-icicle-kit
...
| `led2` | `0x00000012` | `led` |
| `led3` | `0x00000013` | `led` |
| `button1` | `0x0000001e` | `button` |
| `button2` | `0x0000001f` | `button` |
| `button3` | `0x0000001c` | `button` |
| `pac1934` | `0x00010000` | `pac1934` |
| `qspi` | `0x21000000` | `mpfs_qspi` |
| `sysServices` | `0x37020000` | `mpfs_systemservices` |
| `syscontroller_qspi` | `0x37020100` | `mpfs_qspi` |
