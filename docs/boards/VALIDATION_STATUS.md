...
| `stm32h563` | 🟢 silicon-verified | 2026-08-10 | `e258c380c520dccc` | ✖ DRIFT — model 2026-09-18 > capture; RE-CAPTURE |
| `esp32c3` | 🟢 silicon-verified | 2026-08-09 | `9391634fbc6084ee` | ⚠ drift acked 2026-09-17, expires 2026-10-17 (re-capture pending) |
| `nucleo-l476rg` | 🟢 silicon-verified | 2026-08-09 | `9f11d9ce0e41c07a` | ✖ DRIFT — model 2026-09-18 > capture; RE-CAPTURE |
| `nucleo-l073rz` | 🟢 silicon-verified | 2026-08-09 | `dacee983ae769022` | ✖ DRIFT — model 2026-09-18 > capture; RE-CAPTURE |
| `stm32f103` | 🟢 silicon-verified | 2026-08-09 | `ea58d23aad12c13f` | ✖ DRIFT — model 2026-09-18 > capture; RE-CAPTURE |
| `stm32f407` | 🟢 silicon-smoke | 2026-06-20 | `2b3f4e53f6b77542` | ✖ DRIFT — model 2026-09-18 > capture; RE-CAPTURE |
...
| `stm32h735` | 🔵 sim-validated (deep model, no HW diff) | — | `5f7b485f2eab1b32` | no silicon capture |
| `stm32f411ceu6` | 🔵 sim-validated (deep model, no HW diff) | — | `115baa6911796f89` | no silicon capture |
...
| `atsamd21g18a` | 🔵 sim-validated (deep model, no HW diff) | — | `ce88c9dd39e710c8` | no silicon capture |
| `nrf54l15` | 🔵 sim-validated (deep model, no HW diff) | — | `ef003000c5b88c0d` | no silicon capture |
...
| `nano-33-iot` | 🟡 smoke-manual | — | `fdde03240f8b5060` | no silicon capture |
| `metro-m4` | 🟡 smoke-manual | — | `270e409953160682` | no silicon capture |
| `arduino-uno-r4-minima` | 🟡 smoke-manual | — | `17904e5bbaaef5fc` | no silicon capture |
| `teensy-41` | 🟡 smoke-manual | — | `fbdee98391c6c1bb` | no silicon capture |
| `stm32f7-discovery` | 🟡 smoke-manual | — | `d2143139eada71b4` | no silicon capture |
...
- Drift status: **✖ DRIFT — model 2026-09-18 > capture; RE-CAPTURE**
