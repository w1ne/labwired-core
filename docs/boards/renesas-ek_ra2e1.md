# Validation Report: renesas-ek_ra2e1
...
|---|---|---|
| `led_blue` | `0x0000000f` | `led` |
| `led_green` | `0x0000000e` | `led` |
| `led_red` | `0x0000000d` | `led` |
| `button_s2` | `0x0000000f` | `button` |
| `button_s1` | `0x00000004` | `button` |
