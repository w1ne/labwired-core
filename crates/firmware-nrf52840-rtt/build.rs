...
fn main() {
    ...
    println!("cargo:rerun-if-changed=vendor/SEGGER_RTT.c");
    println!("cargo:rerun-if-changed=vendor/SEGGER_RTT.h");
    println!("cargo:rerun-if-changed=vendor/SEGGER_RTT_Conf.h");
}
