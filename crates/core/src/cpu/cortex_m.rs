    ...
    fn step_execute<B: Bus + ?Sized>(
        ...
        if execute {
            ...
            match instruction {
                ...
                | Instruction::VfmaF32 { .. }
                | Instruction::VfmsF32 { .. }
                | Instruction::VfnmaF32 { .. }
                | Instruction::VfnmsF32 { .. }
                | Instruction::VmovSnRt { .. }
                | Instruction::VmovRtSn { .. }
                | Instruction::VmovF32Reg { .. }
                | Instruction::VmovF32Imm { .. }
                ...
                Instruction::Unknown32(..) | Instruction::Unknown(..) => {
                    self.exec_misc(
                        bus,
                        instruction,
                        &mut pc_increment,
