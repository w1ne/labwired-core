...
fn test_chip_config_validation() {
    ...
    bus.write_u32(0x4001100C, 0x1234).expect("Failed to write to GPIOC");
    ...
    bus.write_u32(0x40005408, 0x55AA).expect("Failed to write to I2C1_OAR1");
    let oar1 = bus.read_u32(0x40005408).expect("Failed to read from I2C1_OAR1");
