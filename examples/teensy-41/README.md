...
Teensy 4.1 silicon is **MIMXRT1062**; the chip yaml is the Renode **RT1064** cousin (GPIO/LPUART/CCM class). Do not claim 4MB SiP flash or FlexSPI XIP — SRAM/DTCM linked only.
...
3. `REQUIRED_DOCS.md`: source-grounding references (IMXRT1060RM, PJRC pinout; Renode as address cross-check only).
